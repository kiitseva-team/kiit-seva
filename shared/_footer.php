    ...
    <div class="container">
      <div class="row">
        <div class="col-md-4">
          ...
          <p>KIIT MANAGEMENT SYSTEM</p>
          <!-- Display time zone -->
          <p>Location: Bhubneswar, Odisha, India </p>
        </div>
        <div class="col-md-4">
          <p>Time Zone: <?php
      ...
      <div class="row mt-4">
        <div class="col-md-12">
          <p>&copy; <?php echo date('Y'); ?> By <a href="" target="_blank">Kushagra and Manajit </a>. All rights reserved.</p>
        </div>
      </div>
    </div>
  </footer>
